...
y_pred_cv = cross_val_predict(random_forest, X_balanced, y_balanced, cv=10)
...
plot_confusion_matrix(y_balanced, y_pred_cv, accuracy_cv, precision_cv, recall_cv, f1_cv, title='Matriz de Confusão - Random Forest (CV)')
...
falsos_positivos.to_csv('RandomForestClassifierfalsos_positivos.csv', sep=';', index=True)
falsos_negativos.to_csv('RandomForestClassifierfalsos_negativos.csv', sep=';', index=True)
